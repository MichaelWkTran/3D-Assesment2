...
void CCamera::Inputs(GLFWwindow* _Window)
{
	...
	{
		m_v3Position += m_fSpeed * -glm::normalize(glm::cross(m_v3Orientation, glm::vec3(0.0f,1.0f,0.0f)));
	}
	...
	{
		m_v3Position += m_fSpeed * glm::vec3(0.0f,1.0f,0.0f);
	}
	...
	if (glfwGetMouseButton(_Window, GLFW_MOUSE_BUTTON_LEFT) == GLFW_PRESS)
	{
		...
		glm::vec3 newOrientation = glm::rotate(m_v3Orientation, glm::radians(-fRotX), glm::normalize(glm::cross(m_v3Orientation, glm::vec3(0.0f,1.0f,0.0f))));
		...
		m_v3Orientation = glm::rotate(m_v3Orientation, glm::radians(-fRotY), glm::vec3(0.0f,1.0f,0.0f));
